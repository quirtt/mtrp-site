export default function Footer() {
    return (
    <footer className="bg-[#122038]">
          <div className="mx-auto w-auto max-w-screen-xl p-4 h-100 py-6 lg:py-8">
            <div className="sm:flex sm:items-center sm:justify-between">
                <div className='flex flex-row flex-grow justify-between'>
                  <div className='flex flex-row'>
                    <p className="text-3xl mx-10 text-[#E2E3EE]">Contact Us</p>
                    <div className="flex grow mt-4 sm:justify-center sm:mt-0">
                      <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                          <svg className="w-8 pl-4 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                  ...
                  <div className="justify-end">
                    <img src="" alt="Integration Logo" />
                    <a href="">Know More About Integration</a>
                  </div>
                </div>
